package my.com.myviewset.widget.rollnumber;
...
public class RollNumberView extends View {
    ...
    private int topMargin = DisplayUtil.dip2px(180);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(mTextWidth + DisplayUtil.dip2px(1), mTextHeight + DisplayUtil.dip2px(1));//加个1dp高度
    }
